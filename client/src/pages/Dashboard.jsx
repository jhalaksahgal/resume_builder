...
const Dashboard = () => {
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
          <button
            ...
            className="h-52 w-full bg-white flex flex-col items-center justify-center rounded-xl gap-3
      text-slate-600 border border-dashed border-slate-300
      hover:border-indigo-500 hover:shadow-xl
      transition-all duration-300 cursor-pointer"
          >
            <PlusIcon className="size-14 p-3 bg-linear-to-br from-indigo-300 to-indigo-500 text-white rounded-full" />
      ...
      transition-all duration-300 cursor-pointer"
          >
            <UploadCloudIcon className="size-14 p-3 bg-linear-to-br from-purple-300 to-purple-500 text-white rounded-full" />
